package com.rajgarhiafsm.features.dashboard.presentation
...
import com.rajgarhiafsm.*
import com.rajgarhiafsm.R
import com.rajgarhiafsm.app.*
import com.rajgarhiafsm.app.NewFileUtils.browseDocuments
import com.rajgarhiafsm.app.NewFileUtils.browsePDFDocuments
import com.rajgarhiafsm.app.NewFileUtils.getExtension
import com.rajgarhiafsm.app.domain.*
import com.rajgarhiafsm.app.types.DashboardType
import com.rajgarhiafsm.app.types.FragType
import com.rajgarhiafsm.app.types.TopBarConfig
import com.rajgarhiafsm.app.uiaction.DisplayAlert
import com.rajgarhiafsm.app.utils.*
import com.rajgarhiafsm.app.utils.AppUtils.Companion.isProfile
...
import com.rajgarhiafsm.features.NewQuotation.*
import com.rajgarhiafsm.features.NewQuotation.api.GetQuotRegProvider
import com.rajgarhiafsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.rajgarhiafsm.features.SearchLocation.SearchLocationFragment
import com.rajgarhiafsm.features.SearchLocation.locationInfoModel
import com.rajgarhiafsm.features.TA.ViewAllTAListFragment
import com.rajgarhiafsm.features.achievement.AchievementFragment
import com.rajgarhiafsm.features.activities.presentation.*
import com.rajgarhiafsm.features.addAttendence.*
import com.rajgarhiafsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.rajgarhiafsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.rajgarhiafsm.features.addAttendence.model.GetReportToFCMResponse
import com.rajgarhiafsm.features.addAttendence.model.GetReportToResponse
import com.rajgarhiafsm.features.addAttendence.model.Leave_list_Response
import com.rajgarhiafsm.features.addorder.presentation.AddOrderFragment
...
import com.rajgarhiafsm.features.addshop.presentation.AddShopFragment
import com.rajgarhiafsm.features.addshop.presentation.OTPVerificationDialog
import com.rajgarhiafsm.features.addshop.presentation.ScanImageFragment
import com.rajgarhiafsm.features.addshop.presentation.ShowCardDetailsDialog
import com.rajgarhiafsm.features.alarm.model.AlarmData
import com.rajgarhiafsm.features.alarm.presetation.AttendanceReportFragment
import com.rajgarhiafsm.features.alarm.presetation.PerformanceReportFragment
import com.rajgarhiafsm.features.alarm.presetation.VisitReportDetailsFragment
import com.rajgarhiafsm.features.alarm.presetation.VisitReportFragment
import com.rajgarhiafsm.features.attendance.AttendanceFragment
import com.rajgarhiafsm.features.attendance.api.AttendanceRepositoryProvider
import com.rajgarhiafsm.features.attendance.model.AttendanceRequest
import com.rajgarhiafsm.features.attendance.model.AttendanceResponse
import com.rajgarhiafsm.features.averageshop.presentation.AverageShopFragment
import com.rajgarhiafsm.features.avgorder.presentation.AverageOrderFragment
import com.rajgarhiafsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.rajgarhiafsm.features.beatCustom.TeamBeatListFragment
import com.rajgarhiafsm.features.billing.presentation.AddBillingFragment
import com.rajgarhiafsm.features.billing.presentation.BillingDetailsFragment
import com.rajgarhiafsm.features.billing.presentation.BillingListFragment
import com.rajgarhiafsm.features.changepassword.presentation.ChangePasswordDialog
import com.rajgarhiafsm.features.chat.model.ChatListDataModel
import com.rajgarhiafsm.features.chat.model.ChatUserDataModel
import com.rajgarhiafsm.features.chat.model.GroupUserDataModel
import com.rajgarhiafsm.features.chat.presentation.*
import com.rajgarhiafsm.features.chatbot.presentation.ChatBotFragment
import com.rajgarhiafsm.features.chatbot.presentation.ChatBotShopListFragment
import com.rajgarhiafsm.features.chatbot.presentation.ReportsFragment
import com.rajgarhiafsm.features.chatbot.presentation.SelectLanguageDialog
import com.rajgarhiafsm.features.commondialog.presentation.CommonDialog
import com.rajgarhiafsm.features.commondialog.presentation.CommonDialogClickListener
import com.rajgarhiafsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.rajgarhiafsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.rajgarhiafsm.features.commondialogsinglebtn.OnDialogClickListener
import com.rajgarhiafsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.rajgarhiafsm.features.contacts.ContactsAddFrag
import com.rajgarhiafsm.features.contacts.ContactsFrag
import com.rajgarhiafsm.features.dailyPlan.prsentation.AllShopListFragment
import com.rajgarhiafsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.rajgarhiafsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.rajgarhiafsm.features.damageProduct.ShopDamageProductListFrag
import com.rajgarhiafsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.rajgarhiafsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.rajgarhiafsm.features.dashboard.presentation.model.ContentListResponseModel
import com.rajgarhiafsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.rajgarhiafsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.rajgarhiafsm.features.device_info.presentation.DeviceInfoListFragment
import com.rajgarhiafsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.rajgarhiafsm.features.document.DocumentRepoFeatureNewFragment
import com.rajgarhiafsm.features.document.presentation.DocumentListFragment
import com.rajgarhiafsm.features.document.presentation.DocumentTypeListFragment
import com.rajgarhiafsm.features.document.presentation.OpenFileWebViewFragment
import com.rajgarhiafsm.features.dymanicSection.presentation.AddDynamicFragment
import com.rajgarhiafsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.rajgarhiafsm.features.dymanicSection.presentation.DynamicListFragment
import com.rajgarhiafsm.features.dymanicSection.presentation.EditDynamicFragment
import com.rajgarhiafsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.rajgarhiafsm.features.home.presentation.HomeFragment
import com.rajgarhiafsm.features.homelocation.presentation.HomeLocationFragment
import com.rajgarhiafsm.features.homelocation.presentation.HomeLocationMapFragment
import com.rajgarhiafsm.features.know_your_state.KnowYourStateFragment
import com.rajgarhiafsm.features.lead.LeadFrag
import com.rajgarhiafsm.features.lead.ViewLeadFrag
import com.rajgarhiafsm.features.leaveapplynew.LeaveHome
import com.rajgarhiafsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.rajgarhiafsm.features.localshops.LocalShopListFragment
import com.rajgarhiafsm.features.localshops.LocalShopListMapFragment
import com.rajgarhiafsm.features.localshops.NearByShopsMapFragment
import com.rajgarhiafsm.features.location.*
import com.rajgarhiafsm.features.location.api.LocationRepoProvider
import com.rajgarhiafsm.features.location.model.*
import com.rajgarhiafsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.rajgarhiafsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.rajgarhiafsm.features.login.ShopFeedbackEntity
import com.rajgarhiafsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.rajgarhiafsm.features.login.presentation.LoginActivity
import com.rajgarhiafsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.rajgarhiafsm.features.logoutsync.presentation.LogoutSyncFragment
import com.rajgarhiafsm.features.marketAssist.MarketAssistTabFrag
import com.rajgarhiafsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.rajgarhiafsm.features.marketAssist.ShopListMarketAssistFrag
import com.rajgarhiafsm.features.marketing.presentation.MarketingPagerFragment
import com.rajgarhiafsm.features.meetinglist.prsentation.MeetingListFragment
import com.rajgarhiafsm.features.member.MapViewForTeamFrag
import com.rajgarhiafsm.features.member.model.TeamLocDataModel
import com.rajgarhiafsm.features.member.model.TeamShopListDataModel
import com.rajgarhiafsm.features.member.presentation.*
import com.rajgarhiafsm.features.menuBeat.MenuBeatFrag
import com.rajgarhiafsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.rajgarhiafsm.features.micro_learning.presentation.MicroLearningListFragment
import com.rajgarhiafsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.rajgarhiafsm.features.myallowancerequest.MyallowanceRequestFragment
import com.rajgarhiafsm.features.myjobs.model.CustomerDataModel
import com.rajgarhiafsm.features.myjobs.presentation.*
import com.rajgarhiafsm.features.myorder.presentation.MyOrderListFragment
import com.rajgarhiafsm.features.myprofile.presentation.MyProfileFragment
import com.rajgarhiafsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.rajgarhiafsm.features.nearbyshops.model.ShopData
import com.rajgarhiafsm.features.nearbyshops.model.ShopListResponse
import com.rajgarhiafsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.rajgarhiafsm.features.nearbyshops.presentation.BeatListFragment
import com.rajgarhiafsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.rajgarhiafsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.rajgarhiafsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.rajgarhiafsm.features.newcollection.CollectionDetailsStatusFragment
import com.rajgarhiafsm.features.newcollection.CollectionShopListFragment
import com.rajgarhiafsm.features.newcollection.NewCollectionListFragment
import com.rajgarhiafsm.features.newcollectionreport.*
import com.rajgarhiafsm.features.notification.NotificationFragment
import com.rajgarhiafsm.features.orderList.NewDateWiseOrderListFragment
import com.rajgarhiafsm.features.orderList.NewOrderListFragment
import com.rajgarhiafsm.features.orderList.OrderListFragment
import com.rajgarhiafsm.features.orderdetail.presentation.OrderDetailFragment
import com.rajgarhiafsm.features.orderhistory.ActivityMapFragment
import com.rajgarhiafsm.features.orderhistory.OrderhistoryFragment
import com.rajgarhiafsm.features.orderhistory.TimeLineFragment
import com.rajgarhiafsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.rajgarhiafsm.features.orderhistory.model.LocationData
import com.rajgarhiafsm.features.pendinglocationinout.PendingOutLocationFrag
import com.rajgarhiafsm.features.performance.GpsStatusFragment
import com.rajgarhiafsm.features.performance.PerformanceFragment
import com.rajgarhiafsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.rajgarhiafsm.features.performance.model.UpdateGpsInputParamsModel
import com.rajgarhiafsm.features.performanceAPP.OwnPerformanceFragment
import com.rajgarhiafsm.features.performanceAPP.PerformanceAppFragment
import com.rajgarhiafsm.features.performanceAPP.allPerformanceFrag
import com.rajgarhiafsm.features.permissionList.ViewPermissionFragment
import com.rajgarhiafsm.features.photoReg.*
import com.rajgarhiafsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.rajgarhiafsm.features.quotation.presentation.*
import com.rajgarhiafsm.features.reimbursement.presentation.*
import com.rajgarhiafsm.features.report.presentation.*
import com.rajgarhiafsm.features.returnsOrder.*
import com.rajgarhiafsm.features.settings.presentation.SettingsFragment
import com.rajgarhiafsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.rajgarhiafsm.features.shopdetail.presentation.*
import com.rajgarhiafsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rajgarhiafsm.features.stock.StockDetailsFragment
import com.rajgarhiafsm.features.stock.StockListFragment
import com.rajgarhiafsm.features.stockAddCurrentStock.AddShopStockFragment
import com.rajgarhiafsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.rajgarhiafsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.rajgarhiafsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.rajgarhiafsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.rajgarhiafsm.features.stockCompetetorStock.CompetetorStockFragment
import com.rajgarhiafsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.rajgarhiafsm.features.survey.SurveyFrag
import com.rajgarhiafsm.features.survey.SurveyViewDtlsFrag
import com.rajgarhiafsm.features.survey.SurveyViewFrag
import com.rajgarhiafsm.features.task.presentation.AddTaskFragment
import com.rajgarhiafsm.features.task.presentation.CalenderTaskFragment
import com.rajgarhiafsm.features.task.presentation.EditTaskFragment
import com.rajgarhiafsm.features.task.presentation.TaskListFragment
import com.rajgarhiafsm.features.taskManagement.TaskManagementFrag
import com.rajgarhiafsm.features.taskManagement.ViewTaskManagementFrag
import com.rajgarhiafsm.features.timesheet.presentation.AddTimeSheetFragment
import com.rajgarhiafsm.features.timesheet.presentation.EditTimeSheetFragment
import com.rajgarhiafsm.features.timesheet.presentation.TimeSheetListFragment
import com.rajgarhiafsm.features.viewAllOrder.CartFragment
import com.rajgarhiafsm.features.viewAllOrder.OrderTypeListFragment
import com.rajgarhiafsm.features.viewAllOrder.ViewAllOrderListFragment
import com.rajgarhiafsm.features.viewAllOrder.ViewCartFragment
import com.rajgarhiafsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.rajgarhiafsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.rajgarhiafsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.rajgarhiafsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.rajgarhiafsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.rajgarhiafsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.rajgarhiafsm.features.viewPPDDStock.ViewOutstandingFragment
import com.rajgarhiafsm.features.viewPPDDStock.ViewPPDDListFragment
import com.rajgarhiafsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.rajgarhiafsm.features.viewPPDDStock.ViewStockFragment
import com.rajgarhiafsm.features.weather.presentation.WeatherFragment
import com.rajgarhiafsm.mappackage.MapActivity
import com.rajgarhiafsm.mappackage.MapActivityWithoutPath
import com.rajgarhiafsm.mappackage.SendBrod
import com.rajgarhiafsm.widgets.AppCustomEditText
...
//            Log.w(TAG, errorMessage);
    ...
    override fun loadFragment(mFragType: FragType, addToStack: Boolean, initializeObject: Any) {
        ...
        //Pref.isMenuContactVisible = true
    ...
    public fun getNamePhoneDetails(): ArrayList<Contact>? {
        ...
        if (cur!!.count > 0) {
            while (cur.moveToNext()) {
                ...
                try{
                    if(name.contains("Baba",ignoreCase = true)) {
                        var gr = cur.getString(cur.getColumnIndex(ContactsContract.CommonDataKinds.Phone.ACCOUNT_TYPE_AND_DATA_SET))
                        val gr2 = cur.getString(cur.getColumnIndex(ContactsContract.Contacts.CONTACT_STATUS_LABEL))
                        var a = 1
                    }
                }catch (ex:Exception){
                    ex.printStackTrace()
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xrajgarhiafsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.rajgarhiafsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
