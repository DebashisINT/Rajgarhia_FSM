package com.rajgarhiafsm.features.logoutsync.presentation
...
import com.rajgarhiafsm.app.AppDatabase
...
import com.rajgarhiafsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.rajgarhiafsm.features.billing.api.AddBillingRepoProvider
import com.rajgarhiafsm.features.billing.model.AddBillingInputParamsModel
...
import com.rajgarhiafsm.features.dashboard.presentation.ReasonDialog
...
import com.rajgarhiafsm.features.document.model.AddEditDocumentInputParams
import com.rajgarhiafsm.features.document.model.DocumentAttachmentModel
...
import com.rajgarhiafsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.rajgarhiafsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.rajgarhiafsm.features.orderhistory.model.*
...
import com.rajgarhiafsm.features.quotation.model.AddQuotInputModel
import com.rajgarhiafsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.rajgarhiafsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.rajgarhiafsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.rajgarhiafsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.rajgarhiafsm.features.timesheet.model.AddTimeSheetInputModel
import com.rajgarhiafsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.rajgarhiafsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.rajgarhiafsm.features.viewAllOrder.model.AddOrderInputProductList
import com.rajgarhiafsm.mappackage.SendBrod
import com.rajgarhiafsm.widgets.AppCustomTextView
import com.rajgarhiafsm.MonitorService
import com.rajgarhiafsm.MySingleton
...
import com.rajgarhiafsm.features.addshop.presentation.ShopExtraContactReq
...
import com.rajgarhiafsm.features.login.model.GetConcurrentUserResponse
import com.rajgarhiafsm.features.login.model.WhatsappApiData
import com.rajgarhiafsm.features.performance.model.Gps_status_list
import com.rajgarhiafsm.features.performance.model.UpdateGpsInputListParamsModel
import com.rajgarhiafsm.features.returnsOrder.ReturnProductList
import com.rajgarhiafsm.features.returnsOrder.ReturnRequest
import com.rajgarhiafsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xrajgarhiafsmlogsample/log.zip").path);
